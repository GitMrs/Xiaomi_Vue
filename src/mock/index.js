...
Mockjs.mock('/api/user/login', 'post', config => {
...
Mockjs.mock(RegExp('/api/user/login' + ".*"), config => {
  console.log(config)
  return {
    status: 0,
    data: {
